    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Have questions or want to join Enigma? Reach out to us through any
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {contactInfo.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-enigma-900 dark:text-white mb-2">
                {item.title}
              </h3>
              <p className="text-enigma-700 dark:text-enigma-300">
                {item.details}
              </p>
            </div>
          ))}
        ...
        <div
          className="flex justify-center space-x-4 mt-8 opacity-0 animate-fade-in"
        ...
        >
          <a
            ...
            className="p-3 rounded-full bg-enigma-500 hover:bg-enigma-600 text-white transition-colors"
          >
            <svg
