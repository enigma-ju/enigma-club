    ...
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="w-full lg:w-1/2 opacity-0 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="relative mx-auto max-w-md">
              <div className="aspect-video rounded-2xl overflow-hidden border border-enigma-200 dark:border-enigma-700 shadow-xl">
                ...
                <div className="glass dark:glass-dark absolute inset-0 flex items-center justify-center p-6 sm:p-8">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-enigma-900 dark:text-white text-center sm:text-left">Our Mission</h3>
          ...
          <div className="w-full lg:w-1/2 space-y-6 mt-8 lg:mt-0">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-enigma-900 dark:text-white">{feature.title}</h3>
                  <p className="text-sm sm:text-base text-enigma-700 dark:text-enigma-200">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
